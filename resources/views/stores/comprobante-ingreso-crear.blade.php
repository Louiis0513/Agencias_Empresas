                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" name="date" value="{{ old('date', date('Y-m-d')) }}" class="w-full rounded-md border-white/10 bg-white/5 text-gray-100" required>
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <div id="parts-container">
                                <div class="flex flex-wrap items-end gap-2 mb-2">
                                    <select name="parts[0][bolsillo_id]" class="flex-1 min-w-[140px] rounded-md border-white/10 bg-white/5 text-gray-100" required>
                                    ...
                                    <input type="text" name="parts[0][reference]" value="{{ old('parts.0.reference') }}" class="w-40 rounded-md border-white/10 bg-white/5 text-gray-100 text-sm" placeholder="Ref. (opcional)" maxlength="100">
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('add-part').addEventListener('click', function() {
                ...
                div.innerHTML = `
                    <select name="parts[${partIndex}][bolsillo_id]" class="flex-1 min-w-[140px] rounded-md border-white/10 bg-white/5 text-gray-100" required>
                        <option value="">Seleccionar bolsillo</option>
