                ...
                <div class="bg-dark-card border border-white/5 overflow-hidden sm:rounded-xl">
                    <div class="p-6 space-y-6">
                        ...
                        <div class="border-l-4 border-indigo-500 pl-4" x-show="totalDestinos > 0">
                            <h3 class="text-sm font-semibold text-gray-100 mb-2">¿De qué bolsillos sale el dinero?</h3>
                            <p class="text-xs text-gray-400 mb-2">La suma debe coincidir con el total: <strong x-text="formatNumber(totalDestinos)"></strong></p>
                            <div id="origenes-container" class="space-y-2">
                                ...
                                <div class="origen-row flex gap-2">
                                    ...
                                    <input type="number" name="origenes[{{ $i }}][amount]" step="0.01" min="0.01" value="{{ $o['amount'] ?? '' }}" class="w-28 rounded-md border-white/10 bg-white/5 text-gray-100" required placeholder="Monto">
                        ...
                        <div class="pt-4">
                            <button type="submit" class="px-4 py-2 bg-brand text-white rounded-xl shadow-[0_0_15px_rgba(34,114,255,0.3)] hover:shadow-[0_0_20px_rgba(34,114,255,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
