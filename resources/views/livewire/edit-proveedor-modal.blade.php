        ...
        <form wire:submit="update" class="p-6">
            ...
            <div class="mt-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea wire:model="direccion" id="edit_direccion" class="block mt-1 w-full rounded-md border-white/10 bg-white/5 text-gray-100 focus:ring-brand focus:border-brand" rows="3" placeholder="Dirección completa"></textarea>
