        ...
        <form wire:submit="save" class="p-6">
            ...
            <div class="mt-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea wire:model="detalles" id="detalles" class="block mt-1 w-full rounded-md border-white/10 bg-white/5 text-gray-100 focus:ring-brand focus:border-brand" rows="3" placeholder="Ej: Nº cuenta corriente, datos del bolsillo..."></textarea>
                    <p class="mt-1 text-xs text-gray-400">Opcional. Datos que necesites para identificar este bolsillo.</p>
