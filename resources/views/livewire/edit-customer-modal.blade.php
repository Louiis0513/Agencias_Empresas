            ...
            <div class="mt-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input wire:model="phone" id="edit_phone" class="block mt-1 w-full" type="text" placeholder="+1234567890" />
                        <x-input-error :messages="$errors->get('phone')" class="mt-1" />
                    </div>
                    <div>
                        <x-input-label for="edit_document_number" value="{{ __('Número de Documento') }}" />
                        <x-text-input wire:model="document_number" id="edit_document_number" class="block mt-1 w-full" type="text" placeholder="DNI, Cédula, Pasaporte" />
