            ...
            @if($this->customer)
                <div class="space-y-4">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-300">Usuario Vinculado</label>
                                @if($this->customer->user)
                                    <div class="mt-1">
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                                            {{ $this->customer->user->name }}
                                        </span>
                                        <p class="mt-1 text-xs text-gray-400">{{ $this->customer->user->email }}</p>
                                    </div>
                                @else
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-300">Tienda</label>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-300">Última Actualización</label>
