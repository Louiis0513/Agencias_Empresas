        ...
        <form wire:submit="save" class="p-6">
            ...
            <div class="mt-6 space-y-4">
                <div>
                    ...
                    <x-text-input wire:model="nombre" id="nombre" class="block mt-1 w-full" type="text" placeholder="Nombre del proveedor o empresa" required />
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input wire:model="numero_celular" id="numero_celular" class="block mt-1 w-full" type="text" placeholder="+1234567890" />
                        <x-input-error :messages="$errors->get('numero_celular')" class="mt-1" />
                    </div>
                    <div>
                        <x-input-label for="telefono" value="{{ __('Teléfono') }}" />
                        <x-text-input wire:model="telefono" id="telefono" class="block mt-1 w-full" type="text" placeholder="Teléfono fijo" />
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input wire:model="nit" id="nit" class="block mt-1 w-full" type="text" placeholder="Número de identificación tributaria" />
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <x-secondary-button type="button" x-on:click="$dispatch('close-modal', 'create-proveedor')">
                    {{ __('Cancelar') }}
                </x-secondary-button>
                <x-primary-button>
                    {{ __('Crear Proveedor') }}
