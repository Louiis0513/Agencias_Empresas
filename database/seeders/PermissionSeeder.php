...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['slug' => 'products.bodegas.view', 'name' => 'Ver bodegas', 'description' => 'Ver catálogo de bodegas y configuración de manejo'],
            ['slug' => 'products.bodegas.create', 'name' => 'Crear bodegas', 'description' => 'Crear bodegas en la tienda'],
            ['slug' => 'products.bodegas.edit', 'name' => 'Editar bodegas', 'description' => 'Editar, inactivar bodegas o cambiar el manejo de bodegas'],
            ['slug' => 'products.bodegas.delete', 'name' => 'Eliminar bodegas', 'description' => 'Eliminar bodegas sin movimientos de inventario'],
            ['slug' => 'products.listas-precios.view', 'name' => 'Ver listas de precios', 'description' => 'Ver nombres y estado de las listas de precios'],
            ['slug' => 'products.listas-precios.edit', 'name' => 'Editar listas de precios', 'description' => 'Renombrar y activar/inactivar listas de precios'],
