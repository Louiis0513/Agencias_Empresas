...
/**
 * Une roles.module y workers.module en un solo PlanFeature (equipo / personal).
 */
return new class extends Migration
{
    private const NEW_SLUG = 'team.module';
    ...
    public function up(): void
    {
        ...
        $permissionIds = DB::table('permissions')
            ->where(function ($q) {
                $q->where('slug', 'like', 'roles.%')
                    ->orWhere('slug', 'like', 'workers.%');
            })
            ->pluck('id');
