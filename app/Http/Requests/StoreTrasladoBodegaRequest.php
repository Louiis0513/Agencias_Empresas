...
class StoreTrasladoBodegaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'lineas.*.bodega_origen_id' => ['nullable', 'integer'],
            'lineas.*.bodega_destino_id' => ['nullable', 'integer'],
    ...
    {
        return [
            'fecha.required' => 'La fecha de traslado es obligatoria.',
